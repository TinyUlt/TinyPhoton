...
class ProductItemContent : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gt_msg.ProductItemContent) */ {
 public:
  ...
  // optional bool waitUntilDone = 9;
  void clear_waituntildone();
  static const int kWaitUntilDoneFieldNumber = 9;
  bool waituntildone() const;
  void set_waituntildone(bool value);

  // optional bool fastenOldFish = 10;
  void clear_fastenoldfish();
  static const int kFastenOldFishFieldNumber = 10;
  bool fastenoldfish() const;
  void set_fastenoldfish(bool value);

  // optional bool fastenIn = 11;
  void clear_fastenin();
  static const int kFastenInFieldNumber = 11;
  bool fastenin() const;
  ...
  // optional bool foldX = 14;
  void clear_foldx();
  static const int kFoldXFieldNumber = 14;
  bool foldx() const;
  void set_foldx(bool value);

  // optional bool foldY = 15;
  void clear_foldy();
  static const int kFoldYFieldNumber = 15;
  bool foldy() const;
  void set_foldy(bool value);

  // optional bool foldZ = 16;
  void clear_foldz();
  static const int kFoldZFieldNumber = 16;
  bool foldz() const;
  void set_foldz(bool value);

  // optional float speedScale = 17;
  void clear_speedscale();
  static const int kSpeedScaleFieldNumber = 17;
  float speedscale() const;
  void set_speedscale(float value);

  // optional int32 deep = 18;
  void clear_deep();
  static const int kDeepFieldNumber = 18;
  ::google::protobuf::int32 deep() const;
  void set_deep(::google::protobuf::int32 value);

  // repeated .gt_msg.MessageTimer messageList = 19;
  int messagelist_size() const;
  void clear_messagelist();
  static const int kMessageListFieldNumber = 19;
  ...
  // optional bool isYuZhen = 20;
  void clear_isyuzhen();
  static const int kIsYuZhenFieldNumber = 20;
  bool isyuzhen() const;
  void set_isyuzhen(bool value);

  // optional string rootMessage = 21;
  void clear_rootmessage();
  static const int kRootMessageFieldNumber = 21;
...
class EstablishFishExternal : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gt_msg.EstablishFishExternal) */ {
 public:
  ...
  // optional bool WaitUntilDone = 3;
  void clear_waituntildone();
  static const int kWaitUntilDoneFieldNumber = 3;
  bool waituntildone() const;
  void set_waituntildone(bool value);

  // optional string RootMessage = 4;
  void clear_rootmessage();
  static const int kRootMessageFieldNumber = 4;
  const ::std::string& rootmessage() const;
  void set_rootmessage(const ::std::string& value);
  void set_rootmessage(const char* value);
  void set_rootmessage(const char* value, size_t size);
  ...
  // optional int32 RedBagScore = 5;
  void clear_redbagscore();
  static const int kRedBagScoreFieldNumber = 5;
  ::google::protobuf::int32 redbagscore() const;
  void set_redbagscore(::google::protobuf::int32 value);

  // optional int32 RedBagType = 6;
  void clear_redbagtype();
  static const int kRedBagTypeFieldNumber = 6;
...
class EstablishFish : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gt_msg.EstablishFish) */ {
 public:
  ...
  // optional bool isRedFish = 6;
  void clear_isredfish();
  static const int kIsRedFishFieldNumber = 6;
  bool isredfish() const;
  void set_isredfish(bool value);
  ...
  // optional bool isRedBagFish = 19;
  void clear_isredbagfish();
  static const int kIsRedBagFishFieldNumber = 19;
  bool isredbagfish() const;
  void set_isredbagfish(bool value);
...
class UpdateRedBag : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gt_msg.UpdateRedBag) */ {
 public:
  ...
  // optional int32 RedBagScore = 1;
  void clear_redbagscore();
  static const int kRedBagScoreFieldNumber = 1;
  ::google::protobuf::int32 redbagscore() const;
  void set_redbagscore(::google::protobuf::int32 value);
...
inline float CurrentFrame::frame() const {
  // @@protoc_insertion_point(field_get:gt_msg.CurrentFrame.frame)
  return frame_;
}
inline void CurrentFrame::set_frame(float value) {
...
// optional bool isRedFish = 6;
inline void EstablishFish::clear_isredfish() {
  isredfish_ = false;
}
inline bool EstablishFish::isredfish() const {
  // @@protoc_insertion_point(field_get:gt_msg.EstablishFish.isRedFish)
  return isredfish_;
}
inline void EstablishFish::set_isredfish(bool value) {
  
  isredfish_ = value;
  // @@protoc_insertion_point(field_set:gt_msg.EstablishFish.isRedFish)
}
...
// optional bool isRedBagFish = 19;
inline void EstablishFish::clear_isredbagfish() {
  isredbagfish_ = false;
}
inline bool EstablishFish::isredbagfish() const {
  // @@protoc_insertion_point(field_get:gt_msg.EstablishFish.isRedBagFish)
  return isredbagfish_;
}
inline void EstablishFish::set_isredbagfish(bool value) {
  
  isredbagfish_ = value;
  // @@protoc_insertion_point(field_set:gt_msg.EstablishFish.isRedBagFish)
}
...
// optional int32 RedBagScore = 1;
inline void UpdateRedBag::clear_redbagscore() {
  redbagscore_ = 0;
}
inline ::google::protobuf::int32 UpdateRedBag::redbagscore() const {
  // @@protoc_insertion_point(field_get:gt_msg.UpdateRedBag.RedBagScore)
  return redbagscore_;
}
inline void UpdateRedBag::set_redbagscore(::google::protobuf::int32 value) {
  
  redbagscore_ = value;
  // @@protoc_insertion_point(field_set:gt_msg.UpdateRedBag.RedBagScore)
}
